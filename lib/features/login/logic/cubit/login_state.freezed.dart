...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(UserLoginResponseBody user) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(UserLoginResponseBody user)? success,
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({UserLoginResponseBody user});
}
...
abstract class Success implements LoginState {
  const factory Success({required final UserLoginResponseBody user}) =
      _$SuccessImpl;

  UserLoginResponseBody get user;
